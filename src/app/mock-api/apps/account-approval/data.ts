...
export const accountApprovals = [
    {
        ...
        status      : 'pending',
        readStatus  :  'unread',
        createdDate  : new Date('2021-08-01'),
        lastUpdatedDate : new Date('2021-08-01'),
        idDocType   : 'National ID card',
        idNumber    : 'SDF25626526222JJULH',
        idDocPicture: 'assets/images/avatars/avatar.jpg',
        businessName: 'Vitricomp',
        email       : 'mailto@vitrico.com',
        phoneNumber : {
            countryCode: 'bs',
            number: '1254684365'
        },
        address1    : '279 Independence Avenue',
        address2    : 'Calvary, Guam,',
        city        : 'Calvary',
        state       : 'Guam',
        zip         : 'PO35648',
        country     : 'Bahamas',
        website     : 'www.vitricomp.io',
        documentAttachments: [
            {
                name: 'certificate-of-inc.pdf',
                size: 6265115
            },
            {
                name: 'tax-identification-certificate.xls',
                size: 89265115
            },
            {
                name: 'company-prospectus.docx',
                size: 1556216
            }
        ]
    },
    {
        id          : 'cd5fa417-b667-492d-b208-798dad93213c',
        firstName   : 'Alex',
        lastName    : 'Riley',
        status      : 'approved',
        readStatus  :  'unread',
        createdDate  : new Date('2021-08-05'),
        lastUpdatedDate : new Date('2021-08-05'),
        idDocType   : 'Passport',
        idNumber    : '216531561135163123131',
        idDocPicture: 'assets/images/avatars/brian-hughes.jpg',
        businessName: 'RJ Enterprise',
        email       : 'info@rjetprz.com',
        phoneNumber : {
            countryCode: 'bz',
            number: '3654896365'
        },
        address1    : '279 Alan Avenue',
        address2    : 'Jacklo, Samoa',
        city        : 'Jaclo',
        state       : 'Samoa',
        zip         : 'PO35548',
        country     : 'Brazil',
        website     : 'www.rjetprz.com',
        documentAttachments: [
            {
                name: 'certificate-of-inc.pdf',
                size: 3265115
    ...
    {
        id          : 'cd5fa417-b667-492d-b208-55d93213c',
        firstName   : 'Aden',
        lastName    : 'Smith',
        status      : 'pending',
        readStatus  :  'unread',
        ...
        idNumber    : '99121264185516',
        idDocPicture: 'assets/images/avatars/male-01.jpg',
        businessName: 'Leads Inc.',
        email       : 'contact@leadsinc.com',
        phoneNumber : {
            countryCode: 'mx',
            number: '9854684365'
        },
        address1    : '25/5 Scout Avenue',
        address2    : 'Razundevi bay area, Rimir',
        city        : 'Culiacán',
        state       : 'Sinaloa',
        zip         : 'PO63548',
        country     : 'Mexico',
        website     : 'www.leadsinc.com',
        documentAttachments: [
            {
            ...
            {
                name: 'vat-certificate.xls',
                size: 6265115
            }
        ]
    },
    {
        id          : 'cd5fa417-b56121113-208-798dad93213c',
        firstName   : 'Bert',
        lastName    : 'Bates',
        status      : 'rejected',
        readStatus  :  'read',
        ...
        lastUpdatedDate : new Date(),
        idDocType   : 'National ID card',
        idNumber    : '9SDFSFSDFDFDFDDSSSS898',
        idDocPicture: 'assets/images/avatars/male-02.jpg',
        businessName: 'Jiclo Ltd.',
        email       : 'contact@jicloorltd.com',
        phoneNumber : {
            countryCode: 'ca',
            number: '6954684311'
        },
        address1    : '5/5 Amber Street',
        address2    : 'Holtsville',
        city        : 'Holtsville',
        state       : 'Ontario',
        zip         : 'PO63555',
        country     : 'Canada',
        website     : 'www.jicloorltd.com',
        documentAttachments: [
            {
                name: 'tax-identification.pdf',
                size: 3265115
            },
            {
                name: 'vat-certificate.xls',
    ...
    {
        id          : 'c658a417-b55513-208-7912d5f45d',
        firstName   : 'Sam',
        lastName    : 'Smith',
        status      : 'pending',
        readStatus  :  'unread',
        ...
        lastUpdatedDate : new Date(),
        idDocType   : 'National ID card',
        idNumber    : '9SDFSFS56OPFDFDDSSSS568',
        idDocPicture: 'assets/images/avatars/male-03.jpg',
        businessName: 'Vue Inc.',
        email       : 'info@vue.com',
        phoneNumber : {
            countryCode: 'uk',
            number: '6594684311'
        },
        address1    : '125/9 Outer Circular Road',
        address2    : 'Nottinghamshire district',
    ...
    {
        id          : 'cdsfa417-b5113-208-798dadd5f55d',
        firstName   : 'Albert',
        lastName    : 'Nicolas',
        status      : 'pending',
        readStatus  :  'unread',
        ...
        lastUpdatedDate : new Date(),
        idDocType   : 'Driver\'s license',
        idNumber    : '4700-81-5557',
        idDocPicture: 'assets/images/avatars/male-04.jpg',
        businessName: 'Hobhut Inc.',
        email       : 'albert@hobhut.com',
        phoneNumber : {
            countryCode: 'us',
            number: '2368954168'
        },
        address1    : '524 Neville Street',
        address2    : 'Evansville metropolitan',
        city        : 'Evansville',
        state       : 'Indiana',
        zip         : 'PO47711',
        country     : 'United Sates',
        website     : 'www.hobhut.com',
        documentAttachments: [
            {
                name: 'company-details.pdf',
                size: 5265115
